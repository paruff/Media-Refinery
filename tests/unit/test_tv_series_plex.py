...
async def test_subtitle_compatibility(db):
    ...
    # Not supported
    item2 = MediaItem(id="tv8", source_path="/TV/Show Name/Season 01/Show Name - S01E06.mkv", state=FileState.enriched, media_type=MediaType.series, subtitle_format="pgs")
    db.add(item2)
    await db.commit()
