...
def step_given_file_unclassified(context):
    context.unclassified_path = os.path.abspath("/tmp/test_media_root/unclassified_file.txt")
...
def step_given_movie_file_messy(context):
    context.messy_movie_path = os.path.abspath("/tmp/test_media_root/Movie.Name.2020.1080p.bluray.x264.mkv")
...
def step_given_series_episode_file(context):
    context.series_episode_path = os.path.abspath("/tmp/test_media_root/Show.Name.S01E02.mkv")
...
def step_given_track_file(context):
    context.track_file_path = os.path.abspath("/tmp/test_media_root/01 - Track Title.flac")
...
def step_given_movie_series_album(context):
    ...
    context.album_dir = os.path.abspath("/tmp/test_media_root/Music/Artist/2020 - Album")
...
def step_given_input_audio_file(context):
    context.input_audio_file = os.path.abspath("/tmp/test_media_root/testdata/sample.mp3")
